...
#				echo "Pulling hours from: "$file  #test
				cat $file | awk -F "|" '/ENGAGING/ {print $4;}' >> ~/Documents/tempENG
				cat $file | awk -F "|" '/C3DDB/ {print $4;}' >> ~/Documents/tempC3DDB
			fi
		fi
	done
	echo ""
...
#			echo $file	#test
	...
	echo ""
	echo "Total hours worked for the week beginning "$sdate
	echo "===================================================="
	echo ""
fi
...
#	cat ~/Documents/temphours  #test
	sed '/^$/d' ~/Documents/tempENG> ~/Documents/tempENG2
#	echo ""   #test
#	cat ~/Documents/temphours2  #test
	echo "               ENGAGING: "$(paste -sd+ ~/Documents/tempENG2 | bc)
	echo ""
