...
echo "cehnstrom|$now |$now |0.25|C3DDB|Y|N|care&&feeding" >> $file
echo "cehnstrom|$now |$now |0.25|ENGAGING|Y|N|care&&feeding" >> $file
echo "cehnstrom|$now |$now |0.25|SATORI|Y|N|care&&feeding" >> $file
