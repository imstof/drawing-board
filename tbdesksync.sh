...
then
	...
	#	#sync .msf up, then down
		...
		then
			...
			if rsync -e ssh -uzhav --include="*/" --include="prefs.js" --include="*.msf" --exclude="*" --progress 192.168.13.29:/home/imstof/.thunderbird/3jg4e0zn.default/ /home/imstof/.thunderbird/mv2ohpvu.default/ 
			then
